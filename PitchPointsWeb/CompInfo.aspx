                    ...
                    <div class="col s12 m7">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <asp:GridView ID="CompetitionsGridView" Width="100px" CssClass="bordered highlight responsive-table" runat="server" AutoGenerateColumns="False" DataSourceID="CompDataSource" CellPadding="4" ForeColor="#333333" GridLines="Horizontal">
                                    <Columns>
